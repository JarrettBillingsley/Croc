...
void loadExtensions(MDThread* t)
{
	newNamespace(t, "ext");
	...
	{
		static uword mdglShaderSourceARB(MDThread* t, uword numParams)
		{
		...
		register(t, &mdglShaderSourceARB, "glShaderSourceARB");
...
// 		register(t, &wrapGL!(glMapBufferARB), "glMapBufferARB");
	...
	if(ARBWindowPos.isEnabled)
	{
		...
		register(t, &wrapGL!(glWindowPost2iARB), "glWindowPost2iARB");
...
// 		register(t, &wrapGL!(glMapObjectBufferATI), "glMapObjectBufferATI");
	...
	{
		register(t, &wrapGL!(glRenderbufferStorageMultsampleCoverageNV), "glRenderbufferStorageMultsampleCoverageNV");
...
void loadExtensionFlags(MDThread* t)
{
