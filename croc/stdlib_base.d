...
static:
	...
	alias isParam!(CrocValue.Type.Null)      _isNull;
	alias isParam!(CrocValue.Type.Bool)      _isBool;
	alias isParam!(CrocValue.Type.Int)       _isInt;
	alias isParam!(CrocValue.Type.Float)     _isFloat;
	alias isParam!(CrocValue.Type.Char)      _isChar;
	alias isParam!(CrocValue.Type.String)    _isString;
	alias isParam!(CrocValue.Type.Table)     _isTable;
	alias isParam!(CrocValue.Type.Array)     _isArray;
	alias isParam!(CrocValue.Type.Memblock)  _isMemblock;
	alias isParam!(CrocValue.Type.Function)  _isFunction;
	alias isParam!(CrocValue.Type.Class)     _isClass;
	alias isParam!(CrocValue.Type.Instance)  _isInstance;
	alias isParam!(CrocValue.Type.Namespace) _isNamespace;
	alias isParam!(CrocValue.Type.Thread)    _isThread;
	alias isParam!(CrocValue.Type.NativeObj) _isNativeObj;
	alias isParam!(CrocValue.Type.WeakRef)   _isWeakRef;
	alias isParam!(CrocValue.Type.FuncDef)   _isFuncDef;
