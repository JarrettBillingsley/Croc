...
struct PcreLib
{
	...
	{
		makeModule(t, "pcre", function uword(MDThread* t)
		{
...
static:
	...
	private word[] getGroupRange(MDThread* t, Members* memb, word group)
	{
		if(memb.numGroups == 0)
	...
	public uword numGroups(MDThread* t)
	{
		auto memb = getThis(t);
	...
	public uword groupNames(MDThread* t)
	{
		getThis(t);
	...
	public uword preMatchPost(MDThread* t)
	{
		auto numParams = stackSize(t) - 1;
		auto memb = getThis(t);
		auto range = getGroupRange(t, memb, numParams == 0 ? -1 : 1);
	...
	public uword matchBegin(MDThread* t)
	{
		auto numParams = stackSize(t) - 1;
		auto memb = getThis(t);
		auto range = getGroupRange(t, memb, numParams == 0 ? -1 : 1);
	...
	public uword matchEnd(MDThread* t)
	{
		auto numParams = stackSize(t) - 1;
		auto memb = getThis(t);
		auto range = getGroupRange(t, memb, numParams == 0 ? -1 : 1);
	...
	public uword matchBeginEnd(MDThread* t)
	{
		auto numParams = stackSize(t) - 1;
		auto memb = getThis(t);
		auto range = getGroupRange(t, memb, numParams == 0 ? -1 : 1);
