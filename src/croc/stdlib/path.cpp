...
word_t _normalize(CrocThread* t)
{
...
word_t _toAbsolute(CrocThread* t)
{
	croc_ex_checkParam(t, 1, CrocType_String);
...
word_t _isAbsolute(CrocThread* t)
{
	croc_ex_checkParam(t, 1, CrocType_String);
...
word_t _splitAtLastSep(CrocThread* t)
{
	croc_ex_checkParam(t, 1, CrocType_String);
	auto path = getCrocstr(t, 1);
...
word_t _nameAndExt(CrocThread* t)
{
	croc_ex_checkParam(t, 1, CrocType_String);
	auto path = getCrocstr(t, 1);
...
const _StdlibRegister _globalFuncs[] =
{
	...
	_DListItem(_isAbsolute),
	_DListItem(_join),
	_DListItem(_splitAtLastSep),
	_DListItem(_nameAndExt),
	_DListEnd
};
