...
\
	...
	{
		{"constructor",     3, &_constructor,    0},
		{"fromArray",       2, &_fromArray,      0},
		{"range",           4, &_range,          0},
		{"type",            1, &_type,           0},
		{"itemSize",        0, &_itemSize,       0},
		{"toArray",         2, &_toArray,        0},
		{"toString",        0, &_toString,       0},
		{"getMemblock",     0, &_getMemblock,    0},
		{"dup",             0, &_dup,            0},
		...
		{"pop",             1, &_pop,            0},
		{"sum",             0, &_sum,            0},
		{"product",         0, &_product,        0},
		{"copyRange",       5, &_copyRange,      0},
		{"fill",            1, &_fill,           0},
		...
		{"revdiv",          1, &_revdiv,         0},
		{"revmod",          1, &_revmod,         0},
		{"revsubeq",        1, &_revsubeq,       0},
		{"revdiveq",        1, &_revdiveq,       0},
		{"revmodeq",        1, &_revmodeq,       0},
		{nullptr, 0, nullptr, 0}
	};
