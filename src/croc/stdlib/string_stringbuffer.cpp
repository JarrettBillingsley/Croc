...
const _StdlibRegister _methods[] =
{
	...
	_DListItem(_rstrip),
	_DListItem(_replace),
	_DListItem(_repeat_ip),
	_DListItem(_reverse_ip),
	_DListItem(_strip_ip),
	_DListItem(_lstrip_ip),
	_DListItem(_rstrip_ip),
	_DListItem(_replace_ip),
	_DListItem(_format),
	_DListItem(_formatln),
