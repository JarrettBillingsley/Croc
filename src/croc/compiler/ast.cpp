...
#undef POOP
	...
	int Expression::crocType()
	{
		switch(type)
		{
			case AstTag_NullExp:   return 1;
			case AstTag_BoolExp:   return 1;
			case AstTag_IntExp:    return 1;
			case AstTag_FloatExp:  return 1;
			case AstTag_StringExp: return 1;

			default:
				assert(false); return 1; // dummy
		}
	}
}